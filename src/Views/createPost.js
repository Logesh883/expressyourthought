...
function CreatePost() {
  ...
  const Postcreation = async (e) => {
    ...
    await axios
      .post(`https://express-be.vercel.app/api/post/${Email}`, formData, {
        headers: {
    ...
    <div className="bg-slate-100 min-h-[110vh]">
      ...
      <div className="  mt-3  ">
        ...
        <div className="flex items-center gap-x-32 max-sm:flex-col flex-wrap ">
          ...
          <div className="lg:w-[40rem]  flex flex-wrap  lg:mt-10 max-sm:my-8 border-2 rounded-lg border-x-red-400 border-y-blue-600  max-sm:mb-20  ">
            <form
